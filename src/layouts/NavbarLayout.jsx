...
const NavbarLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* ✅ DRAWER FUERA DEL <nav> — evita el stacking context que lo enterraba */}
      {menuOpen && (
        <div className="sm:hidden fixed inset-0 z-[9999]" onClick={() => setMenuOpen(false)}>
          <div
            className="fixed inset-0 w-full h-full bg-white flex flex-col px-6 py-6 gap-4 animate-slide-in overflow-y-auto"
